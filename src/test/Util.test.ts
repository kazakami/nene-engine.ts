...
import {
    ...
    EachMesh, Limit, NullCoalescing, RandomColor, UndefCoalescing,
} from "../Util";
...
test("Range 1", () => {
    expect(Limit(10, 0, 100)).toBeCloseTo(10);
    expect(Limit(150, 0, 100)).toBeCloseTo(100);
    expect(Limit(10, 50, 100)).toBeCloseTo(50);
    expect(Limit(2.7, 1.6, 4.5)).toBeCloseTo(2.7);
    expect(Limit(0.7, 1.6, 4.5)).toBeCloseTo(1.6);
    expect(Limit(8.7, 1.6, 4.5)).toBeCloseTo(4.5);
});
